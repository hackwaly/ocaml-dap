...
(** [create ~in_ ~out ?next_seq ()] Create a [Debug_rpc.t] instance *)

val event : t -> (module EVENT with type Body.t = 'a) -> 'a React.E.t
(** [event rpc (module The_event)] Get a [The_event.Body.t React.E.t] *)
...
(** [exec_command rpc (module The_command) arg] Execute [The_command] with [arg] on the opposite end. Returns promise of [The_command.Response.Body.t]. You can use [Lwt.cancel] to cancel it. *)
